...
const DerivedConfig = struct {
    ...
    clipboard_paste_translate_newlines: bool,
    ...
    pub fn init(alloc_gpa: Allocator, config: *const configpkg.Config) !DerivedConfig {
        ...
        return .{
            ...
            .clipboard_paste_translate_newlines = config.@"clipboard-paste-translate-newlines",
...
fn completeClipboardPaste(
    ...
    const encode_opts: input.paste.Options = encode_opts: {
        ...
        opts.translate_newlines = self.config.clipboard_paste_translate_newlines;
